...
NSString * const TI_APPLICATION_ID = @"de.appwerft.frogcounter";
NSString * const TI_APPLICATION_PUBLISHER = @"fuerst";
NSString * const TI_APPLICATION_URL = @"http://nabu.de";
NSString * const TI_APPLICATION_NAME = @"FrogCounter";
...
NSString * const TI_APPLICATION_GUID = @"4c36e7cb-0d01-4644-9ccc-5f6f03ceaa35";
