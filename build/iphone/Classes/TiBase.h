...
// in simulator we redefine to format for FrogCounter Developer console
...
{\
	NSString * exceptionName = [@"org.frogcounter." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.frogcounter";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFrogCounterNativeItemNone = -1, 
	UIFrogCounterNativeItemSpinner = -2,
	UIFrogCounterNativeItemProgressBar = -3,
	
	UIFrogCounterNativeItemSlider = -4,
	UIFrogCounterNativeItemSwitch = -5,
	UIFrogCounterNativeItemMultiButton = -6,
	UIFrogCounterNativeItemSegmented = -7,
	
	UIFrogCounterNativeItemTextView = -8,
	UIFrogCounterNativeItemTextField = -9,
	UIFrogCounterNativeItemSearchBar = -10,
	
	UIFrogCounterNativeItemPicker = -11,
	UIFrogCounterNativeItemDatePicker = -12,
	
	UIFrogCounterNativeItemInfoLight = -13,
	UIFrogCounterNativeItemInfoDark = -14,
	
	UIFrogCounterNativeItemDisclosure = -15,
	
	UIFrogCounterNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all FrogCounter instances of
