...
@interface FrogCounterObject : KrollCoverageObject {
#else
@interface FrogCounterObject : KrollObject {
#endif
@private
...
extern NSString * FrogCounter$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FrogCounterObject *_frogcounter;
    KrollObject* console;
	BOOL shutdown;
