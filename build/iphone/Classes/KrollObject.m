...
//@interface FrogCounterObject : NSObject
//@end

@interface FrogCounterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FrogCounterObject class]])
		{
			for (NSString *key in [[(FrogCounterObject*)o modules] allKeys])
			{
