...
/**
 Base class for all FrogCounter views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the FrogCounter view hierarchy (such as wrapped iOS UIViews) was touched.
